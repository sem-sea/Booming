...
class ONDM_Install {
	...
	public static function bundle(): array {
		return [
			...
			'hero-home'         => 'hero-home.webp',
			'over-ons-hero'     => 'over-ons-hero.webp',
			'cta-illustration'  => 'cta-illustration.webp',
			'klaar-start-pack'  => 'klaar-start-pack.webp',
			'testimonial-1'     => 'testimonial-1.webp',
			'testimonial-2'     => 'testimonial-2.webp',
			'pak-social-media'  => 'pak-social-media.webp',
			'pak-lead-magnet'   => 'pak-lead-magnet.webp',
			'pak-website-light' => 'pak-website-light.webp',
		];
	}
