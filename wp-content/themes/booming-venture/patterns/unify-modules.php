	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="bv-value-card">
				...
				<h3 style="margin:0 0 .25rem;font-size:1.125rem;">Strategy</h3>
				<p style="margin:0;color:var(--wp--preset--color--muted);font-size:.9375rem;line-height:1.55;">Market clarity &amp; positioning frameworks.</p>
			</div>
			<!-- /wp:html -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<div class="bv-value-card">
				...
				<h3 style="margin:0 0 .25rem;font-size:1.125rem;">Automation</h3>
				<p style="margin:0;color:var(--wp--preset--color--muted);font-size:.9375rem;line-height:1.55;">Tool integration &amp; workflow blueprints.</p>
			</div>
			<!-- /wp:html -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<div class="bv-value-card">
				...
				<h3 style="margin:0 0 .25rem;font-size:1.125rem;">Prompts</h3>
				<p style="margin:0;color:var(--wp--preset--color--muted);font-size:.9375rem;line-height:1.55;">AI-powered content creation library.</p>
			</div>
			<!-- /wp:html -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<div class="bv-value-card">
				...
				<h3 style="margin:0 0 .25rem;font-size:1.125rem;">Execution Plan</h3>
				<p style="margin:0;color:var(--wp--preset--color--muted);font-size:.9375rem;line-height:1.55;">30-day implementation roadmap.</p>
			</div>
			<!-- /wp:html -->
		</div>
		<!-- /wp:column -->
