...
<section class="wp-block-group alignfull has-base-color has-brand-dark-gradient-background has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-buttons">
		<!-- wp:button {"backgroundColor":"base","textColor":"booming-700"} --><div class="wp-block-button"><a class="wp-block-button__link has-booming-700-color has-base-background-color has-text-color has-background wp-element-button" href="/#contact">Book your strategy call →</a></div><!-- /wp:button -->
		<!-- wp:button {"className":"is-style-outline","textColor":"base","style":{"border":{"color":"#ffffff"}}} --><div class="wp-block-button is-style-outline has-base-color has-text-color has-border-color" style="border-color:#ffffff"><a class="wp-block-button__link wp-element-button" href="/services/">See services</a></div><!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</section>
<!-- /wp:group -->
